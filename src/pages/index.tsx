...
export default function Home() {
  ...
  const gElement = useRef<Selection<
    SVGGElement,
    unknown,
    null,
    undefined
  ...
  const render = useCallback((el: HTMLDivElement) => {
    ...
    let data = [
      20, 24, 20, 20, 25, 27, 26, 20, 21, 22, 24, 20, 28, 20, 28, 26, 25, 28,
      22, 24, 29, 21, 30, 21, 27, 22, 23, 28, 30, 24
    ];
    const x = scaleLinear()
    ...
    gElement.current
      ...
      .append('circle')
      .attr('r', () =>
        getRandomInt(w.current < 500 ? 5 : 10, w.current < 500 ? 10 : 30)
      )
    ...
    data = [
      12, 14, 12, 17, 12, 14, 19, 13, 16, 17, 17, 14, 10, 19, 18, 16, 10, 11,
      10, 12, 17, 14, 14, 13, 14, 13, 12, 10, 19
    ];
    g = svg.append('g');
    ...
    data = [
      1, 2, 0, 2, 7, 1, 0, 6, 6, 6, 1, 4, 8, 10, 7, 8, 9, 4, 7, 2, 4, 2, 4, 9,
      2, 7, 2, 10, 2, 10
    ];
    g = svg.append('g');
      ...
      >
        ...
        <div className="z-1 relative mb-12 flex w-full flex-col items-center justify-center">
          <Image
            ...
            priority
          />
          <span className="my-4 text-3xl font-bold sm:text-5xl">
